...
def main():
    ...
    while time.time() - start_time < agnt_0.training_time:
        ...
        while not done and ep_step < agnt_0.ep_trial_step:
            ...
            CNN_state = copy.deepcopy(state_t)
            CNN_state = CNN_state.reshape(1,8,8,1)
            ...
            act_arr[0][0] = agnt_0.get_action(CNN_state)
            act_arr[0][1] = agnt_1.get_action(CNN_state)
            act_arr[0][2] = agnt_2.get_action(CNN_state)
            act_arr[0][3] = agnt_3.get_action(CNN_state)
            ...
            CNN_next_state = copy.deepcopy(next_state_t)
            CNN_next_state = CNN_next_state.reshape(1,8,8,1)
            ...
            agnt_0.append_sample(CNN_state, int(act_arr[0][0]), reward_0, CNN_next_state, done)
            agnt_1.append_sample(CNN_state, int(act_arr[0][1]), reward_1, CNN_next_state, done)
            agnt_2.append_sample(CNN_state, int(act_arr[0][2]), reward_2, CNN_next_state, done)
            agnt_3.append_sample(CNN_state, int(act_arr[0][3]), reward_3, CNN_next_state, done)
            
            # print(act_arr[0][0])
            # print(reward_0, reward_1, reward_2, reward_3)
            # sys.exit()
    ...
    agnt_0.model.save_weights(model_path + "/CNN_preda_prey_0.h5")
    agnt_1.model.save_weights(model_path + "/CNN_preda_prey_1.h5")
    agnt_2.model.save_weights(model_path + "/CNN_preda_prey_2.h5")
    agnt_3.model.save_weights(model_path + "/CNN_preda_prey_3.h5")
